...
if __name__ == '__main__':
    ...
    paser.add_argument('-j','--java_project_path',help = "the path of java project to be tested",default= "example-project/micro_service_seclab")
    paser.add_argument('-d','--database_path',help = "The location where the codeql database is generated",default= "example-project/micro_service_seclab/qldb")
    paser.add_argument('-r','--results_path',help= "The path to store the sarif results", default='result/codeql.json')
    paser.add_argument('-q','--query_path',help = "The path of the ql query statement",default="ql-query-example/micro-qlpack.ql")
